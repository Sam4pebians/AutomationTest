...
export class ListComponentSelectors {
    public static getListItemByTextXpath(
      ...
      insidePopup = false
        ...
        return `${ModalComponentSelectors.getModelPopupXpath(insidePopup)}//${HtmlHelper.tags.li
          }[${ComponentHelpers.getXPathFunctionForText(text, isContains)}]`;
    }
    ...
    public static getListItemByClass(
      ...
      insidePopup = false
        ...
        return `${ModalComponentSelectors.getModelPopupXpath(insidePopup)}
        //${HtmlHelper.tags.li}[${ComponentHelpers.getXPathFunctionForClass(
          classAttributeValue,
          isContains)}]`;
    }
    ...
    public static getDivInsideListItemByNgRepeatAndClassXpath(
      ...
      insidePopup = false
        ...
        return `${ModalComponentSelectors.getModelPopupXpath(insidePopup)}
        //${HtmlHelper.tags.li}[${ComponentHelpers.getXPathFunctionForNgRepeat(
          ngRepeatAttributeValue, containsNgRepeat)}]${TextComponentSelectors.getDivTextByClassXpath(
            classAttributeValue,
            containsClass
            )}`;
    }
